...
- [x] Phase 1 — Migration file (`supabase/migrations/20260823150404_flashcard_schema.sql` + `supabase/seed.sql`)
- [ ] Phase 2 — TypeScript type generation (`src/types/database.ts`, `src/types.ts`)
